...
int main() {
  node *root;
  char instruction, reply;
  int key, value;

  root = NULL;

  printf("Do you want to enter values?(y/n): ");
  scanf(" %c", &reply);
  if(reply == 'y') {
    printf("Read your instructions below carefully: \n"
        "For each time enter the characters for the corressponding actions\n"
        "i: Insert a new record\n"
        "d: Delete an existing record\n"
        "s: Search a record by key\n"
        "t: Terminate the process\n"
        "NOTE: Entering any other data stops the process\n");

    printf("Enter your instruction: ");
    scanf(" %c", &reply);

    while(reply == 'i' || reply == 'd' || reply == 's') {
        if(reply == 'i') {
            printf("Enter the key-value pair (Format: 'key value' (without quotes)): ");
            scanf(" %d %d", &key, &value);
            ...
            printf("Enter the key of the record to be searched for: ");
            scanf(" %d", &key);
            find_and_print(root, key, true);
        }
    ...
    printf("On inserting record (5, 33):\n");
    root = insert(root, 5, 33);
    print_tree(root);
    printf("\n");

    printf("On inserting record (15, 21):\n");
    root = insert(root, 15, 21);
    print_tree(root);
    printf("\n");

    printf("On inserting record (25, 31):\n");
    root = insert(root, 25, 31);
    print_tree(root);
    printf("\n");

    printf("On inserting record (35, 41):\n");
    root = insert(root, 35, 41);
    print_tree(root);
    printf("\n");

    printf("On inserting record (45, 10):\n");
    root = insert(root, 45, 10);
    print_tree(root);
    printf("\n");

    printf("On inserting record (20, 21):\n");
    root = insert(root, 20, 21);
    print_tree(root);
    printf("\n");

    printf("On inserting record (40, 99):\n");
    root = insert(root, 40, 99);
    print_tree(root);
    printf("\n");

    printf("On inserting record (55, 31):\n");
    root = insert(root, 55, 31);
    print_tree(root);
    printf("\n");

    printf("On inserting record (30, 76):\n");
    root = insert(root, 30, 76);
    print_tree(root);
    printf("\n");

    printf("On deleting the record with key 30: \n");
    root = delete_key(root, 30);
    print_tree(root);
    printf("\n");

    printf("On deleting the record with key 5: \n");
    root = delete_key(root, 5);
    print_tree(root);
    printf("\n");

    printf("On deleting the record with key 45: \n");
    root = delete_key(root, 45);
    print_tree(root);
    printf("\n");

    printf("On deleting the record with key 25: \n");
    root = delete_key(root, 35);
    print_tree(root);
    printf("\n");

    printf("On deleting the record with key 40: \n");
    root = delete_key(root, 40);
    print_tree(root);
    printf("\n");

    printf("On deleting the record with key 55: \n");
    root = delete_key(root, 55);
    print_tree(root);
    printf("\n");
    ...
    printf("On deleting the record with key 15: \n");
    root = delete_key(root, 15);
    print_tree(root);
    printf("\n");

    printf("On deleting the record with key 20: \n");
